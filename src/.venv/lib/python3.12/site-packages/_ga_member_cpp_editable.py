...
install({'ga_member_cpp': "/Users/carlabecker/Library/Mobile Documents/com~apple~CloudDocs/Carla's Desktop/UC Berkeley/Research/Smart Farm/smartfarm/src/smartfarm/core/python/ga_member_cpp/__init__.py"}, {'ga_member_cpp._core': 'ga_member_cpp/_core.cpython-312-darwin.so'}, None, False, True, [], [], '')
